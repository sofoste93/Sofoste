...
class SecureAdminCookieStorage(context: Context) : CookiesStorage {
    ...
    private fun write(cookie: StoredAdminCookie) {
    ...
    private fun read(): StoredAdminCookie? {
        ...
        return runCatching {
            ...
            json.decodeFromString<StoredAdminCookie>(
    ...
    @Serializable
    private data class StoredAdminCookie(
        val value: String,
        val domain: String,
        val path: String,
        val secure: Boolean,
    ...
    private companion object {
        const val COOKIE_NAME = "sofoste_admin_mobile"
        const val PREFERENCES_NAME = "sofoste_admin_mobile_session"
        const val PREFERENCE_COOKIE = "encrypted_cookie"
        const val KEYSTORE_PROVIDER = "AndroidKeyStore"
        const val KEY_ALIAS = "sofoste_admin_mobile_cookie_v1"
        const val TRANSFORMATION = "AES/GCM/NoPadding"
        const val SESSION_LIFETIME_MS = 4L * 60L * 60L * 1_000L
    }
}
